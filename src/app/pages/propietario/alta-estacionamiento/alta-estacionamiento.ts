...
import { DiaSemana, NuevoEstacionamiento } from '@app/models';
 ...
 *
 * Alta de estacionamiento: datos, direccion, tarifa y los horarios de la
 * semana. Al crearlo lleva directo a cargar sus cocheras.
 */
@Component({
