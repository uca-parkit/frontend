...
import { Boton, Cargando, Chip, EstadoVacio, Etiqueta, Tarjeta } from '../../components/ui';
import { ETIQUETA_TIPO_VEHICULO, NuevoVehiculo, TipoVehiculo, Vehiculo } from '../../models';
import { VehiculoService } from '../../services/vehiculo.service';

/** Orden de los chips, igual que en los filtros de explorar. */
const TIPOS: TipoVehiculo[] = ['AUTO', 'MOTO', 'CAMIONETA'];

/** Vehiculos del conductor: listado y alta (rol CONDUCTOR). */
@Component({
